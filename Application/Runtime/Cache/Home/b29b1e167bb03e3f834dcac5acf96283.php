<?php if (!defined('THINK_PATH')) exit();?> <!DOCTYPE html>
 ...
 <head>
 	...
 	<!-- <link rel="stylesheet" type="text/css" href="/HouseR/public/bootstrap-3.3.7-dist/css/bootstrap.css"> -->
 </head>
 <body>
 	<div class="bd">
 		...
 		<div class="search_p">
 			<div class="search_p_l">
				...
				<!-- <?php if(is_array($location_city)): $i = 0; $__LIST__ = $location_city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div><?php echo ($vo["cityname"]); ?></div><?php endforeach; endif; else: echo "" ;endif; ?> -->
			</div>
		</div>
				...
				<ul id="house_list_ul">
						<!-- <li>
							...
							<div class='h_detail layui-col-md7 layui-col-sm8 layui-col-xs12'>
								<div><?php echo ($data[0]["title"]); ?></div>
								<div style='float: left;'>
									<div><i class='fa fa-map-marker fa-fw'></i><?php echo ($data['data'][0]["livingrooms"]); ?>厅<?php echo ($data[0]["rooms"]); ?>房</div>
									<div><i class='fa fa-home fa-fw'></i><?php echo ($data[0]["address"]); ?></div>
								</div>
							</div>
...
<!-- <script type="text/javascript" src="/HouseR/public/js/islogin.js" charset="utf-8"></script> -->
<!-- <script type="text/javascript" src="/HouseR/public/bootstrap-3.3.7-dist/js/bootstrap.js"></script> -->
<script type="text/javascript">
    ...
    function URLHref(){
    	var url="/HouseR/index.php/Home/Rent/index";
