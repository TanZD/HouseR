...
<body>
	...
	<script type="text/javascript">
		...
		table.render({
            elem: '#demo1'
            //,height: 315
            ,url: "/HouseR/Homepage/Index/task_list1" //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'id',event: 'setSign', title: 'ID', width:80, sort: true, fixed: 'left'}
                ,{field: 'title',event: 'setSign', title: '标题'}
                ,{field: 'add_time',event: 'setSign', title: '创建时间', width:170}
                ,{field: 'time',event: 'setSign', title: '签约时间', width:170}
                ,{field: 'start_time',event: 'setSign', title: '起租时间', }
                ,{field: 'end_time',event: 'setSign', title: '到租时间',  }
                ,{field: 'price_month',event: 'setSign', title: '月租(元)'}
                ,{field: 'price_total',event: 'setSign', title: '租金总额(元)',}
                ,{field: 'u_a_name',event: 'setSign', title: '房东id'}
                ,{field: 'u_b_name',event: 'setSign', title: '租客id'}
            ]]
            ,page: true
            ,limit:3
        ...
        //监听单元格事件
		  table.on('tool(demoEvent)', function(obj){
		    ...
		    if(obj.event === 'setSign'){
		        ...
		        window.location.href="/HouseR/Homepage/Index/MycontractDetail?house_id="+obj.data['house_id']+"&&id="+obj.data['id'];
