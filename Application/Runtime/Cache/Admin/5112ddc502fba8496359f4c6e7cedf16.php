                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
							...
							<div class="layui-inline layui-show-xs-block">
                                <input type="text" name="title"  placeholder="房屋名" autocomplete="off" class="layui-input">
                            </div>
               
                            <div class="layui-inline layui-show-xs-block">
                                <input type="text" name="host_id"  placeholder="房东id" autocomplete="off" class="layui-input">
                            </div>
								
							<div class="layui-input-inline layui-show-xs-block">
                                    <input class="layui-input" placeholder="登记时间" name="add_time" id="add_time">
							</div>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="td-manage">
                                      ...
                                      <a title="详情" onclick="xadmin.open('房屋详细信息','house-message.html')" href="javascript:;">
