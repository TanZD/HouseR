			...
			<div class="">
					<div class="hd_request">
						<ul>
							...
							<li class="hd_request layui-col-md5 layui-col-sm5 layui-col-xs12" id="mc_b_id" style="float: right;"><span>租户id:</span></li>
							<li class="hd_request layui-col-md5 layui-col-sm5 layui-col-xs12" id="mc_b_name"><span>租户名:</span></li>
							<li class="hd_request layui-col-md5 layui-col-sm5 layui-col-xs12" id="mc_bp" style="float: right;"><span>租户电话号码:</span></li>
							<div style="clear: both;"></div>
						</ul>
					</div>
				</div>
				...
				<div class="">
					<div class="hd_request">
						<ul>
							...
							<li class="hd_request layui-col-md5 layui-col-sm5 layui-col-xs12" id="dt_hid" style="float: right;"><span>房屋id:</span></li>
							<div style="clear: both;"></div>
						</ul>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#button1").click(function(){
			layer.confirm('确认？', function(index){
				...
				$.ajax({
					...
					data:{"rent_id":contract_detail.data['id'],"house_id":house_detail.data['id'],"content":$("#content").val(),"r_id":house_detail.data['a_user_id']},
		...
		$("#button2").click(function(){
			layer.confirm('确认？', function(index){
				...
				$.ajax({
					...
					data:{"rent_id":contract_detail.data['id'],"content":$("#content").val(),"r_id":house_detail.data['a_user_id']},
					success:function(data){
					  console.log(data);
		...
		if(contract_detail.msg!=-1){
			...
			$("#mc_b_name").append(contract['b_username']);
			$("#mc_b_id").append(contract['b_id']);
			$("#mc_a_id").append(contract['a_id']);
			...
			$("#mc_p").append(contract['a_phone']);
			$("#mc_bp").append(contract['b_phone']);
			$("#mc_aname").append(contract['a_username']);
